async function moduleProject4() {
  ...
  document.querySelector('#citySelect').addEventListener('change', async evt => {
    try {
      ...
      .textContent = `Precipitation: ${data.current.precipitation_possibility * 100}%`
      ...
      data.forcast.daily.forEach((day, idx) => {
        ...
        minMax.textContent = `${day.temperature_min}  / ${day.temperature_min}`
        precipt.textContent = `Precipitaiton: ${day.precipitation_possibility * 100}%`
      })
